...
const dailyRoutine = [
  ...
  "Talk about your best friend's daily routine",
  'What do you usually do in the evening?',
  'When do you brush your teeth?',
  'Can you give some examples of free time activities?',
  'How often do you eat fast food?',
  'How much time do you spend on homework?',
  'Talk about the activities you do after school',
  'Talk about the activities you do before school',
  'Talk about the activities you do on holidays',
  'When do you usually get up?',
  "Talk about your mother's daily routine",
  "Talk about your father's daily routine",
  "What's the longest activity you have ever done?",
  'Make a list of your household duties',
  'Is there a pet in your family? Ehen do you go for a walk with it?',
];

const cartoons = [
  'Do you like the cartoons? Why / Why not?',
  'Have you ever designed a cartoon? WHich?',
  'What are your favourite cartoon characters? Why?',
  'Would you like to be a cartoonist? Why / Why no?',
  'Do you like anime or manga books? Why / Why not?',
  'What was the last comic book you read? When?',
  'Which cartoon did you like as a small child? Why?',
  'Do you think boys read more comic books than girls?',
  'What are the most famous cartoon characters in your country? Are they famous worlwide?',
  'Do you usually buy cartoon books? Which?',
  'Do you watch animated cartoons on TV? Which?',
  'Why do you think adults also like cartoons?',
  'Do you play videogames based on a comic books?',
  'Have you ever been to a comic fair? When and where?',
  'What comic character would you like to be? Why?',
  'Have you ever read any comics in English? Which?',
  'Do you prefer black & white or coloured cartoons?',
  'Why do you think comics are so popular?',
];

const theInternet = [
  'How often do you use the Internet? Where do you use it?',
  'What is your email address? How often do you check you email?',
  'Do you have a computer at home? Is it a desktop or a laptop (also: notebook)?',
  'Do you have a mobile phone? Can you connect to the Internet with in?',
  'What is your favourite website? How often do you visit it?',
  'Have you ever played online games? What is your favourite?',
  'Have you ever bought anything on the Internet? What was it?',
  'What are the most popular goods (and servives) sold online?',
  'Have you ever made new friends on the Internet?',
  'Do you use instant messaging? What software do you use?',
  'Do you chat online? Do you visit chat rooms or use instant messaging?',
  'Have you ever downloaded music or video?',
  'Are you member of a social networking site? (Facebook, Myspace...)',
  'What do you use computers for? How often do you use them?',
  'Which Internet browser do you prefer? WHh? (Firefox, safari...)',
  'WHich operating system do you use? Why? (windows XP, vista, linux...)',
  'Describe the computer you use (make, type, OS, monitor, memory, HD, accesories)',
  'Have you ever used pirated software? Do you think it is okay to use it?',
];

const technology = [
  'What do you think of when you hear the world technology?',
  'In your opinion, which invention has had the greatest impact on society in the last 100 years?',
  ...
  'You are stranded on a desert island. What would you wish you had with you?',
  'How has technology changed the workplace?',
  'Has technology had any impact on education? In what way?',
  'How has technology changed on medical care? Technology has revolutionized transpor. Explain',
  ...
  'Does technology (or the use thereof) ever get on your nerves? (=irritate or annoy you)',
  'How has technology improved our daily lives? GIve examples and explain the advantges of technological advances',
  'Is technological advance always for the better? Can you think of any disadvantges of technology?',
  'Any sufficient advanced technology is indistinguishable from magic. Do you agree?',
  'What could never be replaced by technology? Explain why not?',
  'What would you like to see invented in the future? Explain why',
  '"Modern technology owes ecology an apology" What does this mean? Do you agree?',
];
...
const socialNetworkingSites = [
  ...
  'In your opinion, what is the best social networking site?',
  'Social networking sites are for those who are not good at meeting people face to face. What do you think of this statement?',
  'Have you ever tried to find your soul mate on a social networking site? Was it dangerous?',
  'What did you think when you first used Twitter? DO you think it is a successful site?',
  'What do you think of 140 characters for the Twitter updates? Is it enough?',
  "What do you think of Twitter's slogan, 'What are you doing?'",
  'WHy does Twitter choosee a bird as its logo? How do they make money?',
  'What springs to yuor mind when you hear the word "Facebook"? What do you think of this name?',
  'What do you think of putting personal information on Facebook?',
  'What are your favourite Facebook applications or games?',
  'Have you ever put anything on Facebook that you were regretted?',
  'What would you like Facebook and Twitter to do different?',
  'What are the best things about Facebook and Twitter?',
  'Why are Facebook and Twitter banned in some countries?',
  'What do you think of someone who are addicted to Facebook? How can you help them?',
  "What questions would you like to ask Facebook's and Twitter's inventor or owner",
  'Should a company ban the emplyees from using social networking sits at work? WHy or why not?',
  'What kind of new features would you like to see on social networking sites in the future?',
  "Do you think your country's leader has a page on a social networking site? What do you think it might contain?",
  'Do you think that social networking sites will make people lonelier? Explain why',
  'Would you prefer to meet new people at a party or through internet?',
  'Should children be allowed to use social networking sites? Why or why not?',
];

const socialMedia = [
  'Do you have profile on a social media site? Which ones?',
  'What kind of information is in your profile?',
  'What do you do on social media? (comment, like, post)',
  'Do you check in often?',
  "Have you ever accepted a friend request from someone you aren't sure that you know?",
  'Do you know all of followers on Instagram etc?',
  "What's your favourite thing about social media? Why?",
  "What's the worst thing about social media?",
  'What do you think can be done to change the negative aspects of social media?',
  'What is the worst thing you have ever seen on social media? Why was it so bad?',
  'Do you ever stay up late or get up early to spend more time on social media sites?',
  'Is your privacity important to you? WHy?',
  'Is appearance important to you? Why?',
  'Have you ever been bullied online? Have you ever seen or heard of somebody being bullied online?',
  'Do you think that what you see on social media is real or fake?',
  'Do you ever watch reality TV shows? Do you like them? Why (not)?',
  'Whatever you put online is permanent. How do you feel about this?',
  'Nothing online is completly private. Discuss',
  'Have you ever seen online bulling?',
  'Have you ever watched reality TV?',
  'Have you ever closed a social media profile?',
  'Have you ever lied about yourself on social media?',
  'Have you ever turned off notifications on your phone?',
  'Have you ever refused a friend request?',
  'Have you ever blocked a person on social media?',
];

const superlatives = [
  'What the biggest country in the world? Where is it? What are its neighbours?',
  "What's the most popular country in the world? What's the most populous Muslim country in the world?",
  "What's the highest mountain in the world? In Europe? In South America? In Africa?",
  "What's the longest river in the world? In Asia In North and South America? In Europe?",
  "What's the biggest animal in the world? Where does it live? What does it eat?",
  "What's the biggest land animal? What does it eat?",
  "What's the biggest bird in the world? Where does it live? Describe it",
  "What's the fastest animal on land? Describe it. Who's the farest in the sky?",
  "What's the biggest ocean in the world? Where is it? WHat's the biggest fish?",
  "What's the biggest city in the world? WHat's the biggest city in your country?",
  "What's the largest desert in the world? Where is it? What animals live there?",
  "What's the highest building in the world? What's the highest one in your country?",
  "What's the smallest country in the world? Where is it?",
  'Which country is the most popular tourist destination in the world? Why?',
  "Who's the richest person on Earth? How much money does he have?",
  "What's the hardest substance on Earth? What is it used for?",
  "What's the biggest continent? What's the coldest? What's the driest?",
  ...
  "What's the most tourism attraction in your country?",
...
const temas = {  
  ...
  socialnetworkingsites: socialNetworkingSites,
